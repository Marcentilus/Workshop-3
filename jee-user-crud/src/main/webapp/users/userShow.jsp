          ...
          <div style="background: whitesmoke">
            ...
            <table style="width: 100%; ">
              <tr style="height: 70px">
                <th style="border-bottom: 1px solid #ddd">Id</th>
                <td style="border-bottom: 1px solid #ddd">${user.id}</td>
              </tr>
              <tr style="height: 70px">
                  <th style="border-bottom: 1px solid #ddd">Nazwa użytkownika</th>
                  <td style="border-bottom: 1px solid #ddd">${user.userName}</td>
                </tr>
              <tr style="height: 70px">
                  <th>Email</th>
                  <td>${user.email}</td>
